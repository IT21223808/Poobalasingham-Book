...
export default function StockInPage() {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      setSuccessMessage(
        `${response.data.productName}: ${response.data.quantityAdded} units added successfully. Stock ${response.data.previousStock} → ${response.data.newStock}.`,
      );
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search by product name, code, barcode or ISBN..."
